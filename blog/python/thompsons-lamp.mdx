...
import ThomsonLamp from '../../src/components/ThomsonLamp'

![Generic Lamp](./lamp.jpeg)
...
Regardless of your answer, it still doesn't <i>really</i> answer Thomson's question, but it <i>is</i> definitely a fun exercise. And it's cool to translate a thought experiment into code.
